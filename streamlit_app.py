...
# st.subheader('This is little smaller')
# name = st.text_input('Write your name here')
# if name is not None:
#     st.write(f'Hello {name}')

# complaints = st.text_area('Express your anger here!!!!')


# anger_scale = st.slider('Your anger level',
#                         min_value=1,
#                         max_value=10,
#                         )

# st.selectbox('Favourite food',
#              ['menthoo',
#               'pasta',
#               'pizza',
#               'KFC???',
